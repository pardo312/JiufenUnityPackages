...
namespace Jiufen.Audio.Test
{
    public class TestAudio : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            {
                AudioController.Instance.PlayAudio(AudioType.OST_Main_Theme, new AudioFadeInfo(true, 1.0f));
                Debug.Log("Pressed q");
            }
            ...
            {
                AudioController.Instance.StopAudio(AudioType.OST_Main_Theme, new AudioFades(new AudioFadeInfo(true, 1.0f));
                Debug.Log("Pressed a");
            }
