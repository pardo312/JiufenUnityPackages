...
namespace Jiufen.Audio
{
    public class AudioJob
    {
        ...
        public AudioJob(AudioType audioType, AudioAction audioAction, AudioJobExtras audioJobExtras = null)
        {
            this.type = audioType;
            this.action = audioAction;
            this.audioJobExtras = audioJobExtras!=null?audioJobExtras: new AudioJobExtras();
        }
    }
