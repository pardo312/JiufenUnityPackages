...
namespace Jiufen.Audio
{
    public class AudioController : MonoBehaviour
    {
        ...
        public void PlayAudio(AudioType audioType, float delay = 0.0f, FadeInfo fadeIn = null, FadeInfo fadeOut = null)
        {
            m_audioJobsController.AddJob(new AudioJob(audioType, AudioAction.START, delay, fadeIn, fadeOut, ));
        }
        public void StopAudio(AudioType audioType, float delay = 0.0f, FadeInfo fadeIn = null, FadeInfo fadeOut = null)
        {
            m_audioJobsController.AddJob(new AudioJob(audioType, AudioAction.STOP, delay, fadeIn, fadeOut));
        }
        public void RestartAudio(AudioType audioType, float delay = 0.0f, FadeInfo fadeIn = null, FadeInfo fadeOut = null)
        {
            m_audioJobsController.AddJob(new AudioJob(audioType, AudioAction.RESTART, fade, delay));
        }
