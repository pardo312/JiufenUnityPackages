...
namespace Jiufen.Audio
{
    public class AudioController : MonoBehaviour
    {
        ...
        public void StopAudio(AudioType audioType, AudioFades fades = null, float delay = 0.0f)
        {
            m_audioJobsController.AddJob(new AudioJob(audioType, AudioAction.STOP,fades, delay));
        }
        public void RestartAudio(AudioType audioType, AudioFades fades = null, float delay = 0.0f)
        {
