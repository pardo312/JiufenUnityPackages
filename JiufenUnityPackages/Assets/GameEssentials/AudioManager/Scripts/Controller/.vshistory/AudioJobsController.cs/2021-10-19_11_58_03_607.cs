        ...
        private IEnumerator RunAudioJob(AudioJob _audioJob)
        {
            ...
            switch (_audioJob.action)
            {
                case AudioAction.START:
                    ...
                    break;
                case AudioAction.STOP when !_audioJob.fadeOutPrevious:
                ...
                case AudioAction.STOP:
                    ...
                    {
                        track._audioSource.volume = Mathf.Lerp(_initial, _target, _timer / _duration);
                        _timer += Time.deltaTime;
                        yield return null;
                    }

                    track._audioSource.volume = _target;
                    track._audioSource.Stop();
                    break;
