...
namespace Jiufen.Audio
{
    public class AudioController : MonoBehaviour
    {
        ...
        public void PlayAudio(AudioType audioType, bool fade = false, float fadeTime = 0.0f)
        {
            m_audioJobsController.AddJob(new AudioJob(AudioAction.START, audioType, fade, fadeTime));
        }
        public void StopAudio(AudioType audioType, bool fade = false, float fadeTime = 0.0f)
        {
            m_audioJobsController.AddJob(new AudioJob(AudioAction.STOP, audioType,fade,fadeTime));
        }
        public void RestartAudio(AudioType audioType, bool fade = false, float fadeTime = 0.0f)
        {
            m_audioJobsController.AddJob(new AudioJob(AudioAction.RESTART, audioType,fade,fadeTime));
        }
