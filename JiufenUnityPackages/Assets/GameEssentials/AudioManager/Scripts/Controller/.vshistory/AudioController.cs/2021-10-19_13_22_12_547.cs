...
namespace Jiufen.Audio
{
    public class AudioController : MonoBehaviour
    {
        ...
        public void PlayAudio(AudioType audioType, AudioJobExtras extras = null)
        {
            m_audioJobsController.AddJob(new AudioJob(audioType, AudioAction.START, extras));
        }
        public void StopAudio(AudioType audioType, AudioJobExtras audioJobExtras = null)
        {
            m_audioJobsController.AddJob(new AudioJob(audioType, AudioAction.STOP, audioJobExtras));
        }
        public void RestartAudio(AudioType audioType, AudioJobExtras audioJobExtras = null)
        {
