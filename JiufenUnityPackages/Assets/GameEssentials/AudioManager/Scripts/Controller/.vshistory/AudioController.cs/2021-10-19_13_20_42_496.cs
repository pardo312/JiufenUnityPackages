...
namespace Jiufen.Audio
{
    public class AudioController : MonoBehaviour
    {
        ...
        public void PlayAudio(AudioType audioType, AudioJobExtras audioJobExtras = default)
        {
            m_audioJobsController.AddJob(new AudioJob(audioType, AudioAction.START, audioJobExtras));
        }
        public void StopAudio(AudioType audioType, AudioJobExtras audioJobExtras = default)
        {
            m_audioJobsController.AddJob(new AudioJob(audioType, AudioAction.STOP, audioJobExtras));
        }
        public void RestartAudio(AudioType audioType, AudioJobExtras audioJobExtras = default)
        {
