...
namespace Jiufen.Audio
{
    public class AudioController : MonoBehaviour
    {
        ...
        public void PlayAudio(AudioType audioType, AudioFades fades = null, float delay = 0.0f)
        {
            m_audioJobsController.AddJob(new AudioJob(audioType, AudioAction.START,fades, delay));
        }
        public void StopAudio(AudioType audioType, float delay = 0.0f, AudioFadeInfo fadeIn = null, AudioFadeInfo fadeOut = null)
        {
            m_audioJobsController.AddJob(new AudioJob(audioType, AudioAction.STOP,fades, delay));
        }
        public void RestartAudio(AudioType audioType, float delay = 0.0f, AudioFadeInfo fadeIn = null, AudioFadeInfo fadeOut = null)
        {
            m_audioJobsController.AddJob(new AudioJob(audioType, AudioAction.RESTART,fades, delay));
        }
